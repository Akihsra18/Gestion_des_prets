...
<head>
    ...
    <title>Ajouter périodique</title>
...
<body>
    ...
    <?php
        ...
        $formErrors = false;
        $nomP = $titreP = $anneeP = $moisP = $numeroP = $urlP = "";
    ...
    <?php
            ...
            $sql = "INSERT INTO periodiques (nom, titre, annee, mois, numero, url)
            VALUES ('$nomP', '$titreP', '$anneeP', '$moisP', '$numeroP', '$urlP')";
...
<!-- 
    ...
    MODIFY `id_periodique` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;
-->